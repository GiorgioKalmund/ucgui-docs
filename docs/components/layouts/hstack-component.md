---
sidebar_position: 4
title: HStackComponent
description: A vertical layout built on top of Unity's 'HorizontalLayotGroup'
---

> extends [HorizontalOrVerticalLayoutComponent](./horizontal-or-vertical-layout-component.md)

The HStackComponent is essentially just a wrapper around Unity's [HorizontalLayoutGroup](https://docs.unity3d.com/2022.3/Documentation/Manual/script-HorizontalLayoutGroup.html).
...
[**HStackComponent.cs**](https://www.github.com/GiorgioKalmund/UCGUI/tree/main/Runtime/Components/HStackComponent.cs)
